...
const NavBtn = ({ title, customFunct, icon, color, dotColor }) => (
      ...
      <div className="flex">
        ...
        <TooltipComponent content="Profile" position="BottomCenter">
          ...
          >
            ...
            <p>
              <span className="text-gray400 text-14">Hi, </span>{" "}
              <span className="text-gray400 font-bold ml-1 text-14">Anisa</span>
            </p>
